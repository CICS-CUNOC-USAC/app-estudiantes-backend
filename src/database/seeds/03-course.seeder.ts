...
export async function seed(knex: Knex): Promise<any> {
  const courses = [
    ...
    //Area Comun para las 5 carreras
    {
      ...
      description:
        'EL CURSO DE SOCIAL HUMANÍSTICA 1, TIENE COMO FINALIDAD; EL PROPORCIONAL AL ESTUDIANTE DEL AREA COMUN, DE LAS CARERRAS DE INGENIERIA, DE LA DIVISIÒN DE CIENCIAS DE LA INGENIERIA, DEL CENTRO UNIVERSITARIO DE OCCIDENTE (CUNOC), LOS CONOCIMIENTOS QUE LE PERMITAR TENER UN PANORAMA CIENTÌFICO SOBRE ASPECTOS DE LA SOCIEDAD EN FORMA GENERAL, CONOCIMIENTOS Y ELEMENTOS TEÓRICOS QUE SON INDISPENSABLES PARA INTERPRETAR CIENTÍFICAMENTE EL DESARROLLO DE LA SOCIEDAD.',
      credits: 4,
    }, //si esta correcto en todos los pensums
    {
      ...
      description:
        'En este curso el alumno analizara conceptos, teorías, procedimientos, gráficas, y principios de modelado sobre los temas de: conjuntos, números reales, funciones, límites, derivadas, integrales, ecuaciones diferenciales, geometría analítica, vectores, matrices, determinantes, sistemas de ecuaciones lineales, y aplicaciones de las matemáticas en la ingeniería.',
      credits: 7,
    ...
    }, //creditos correctos entre todos los pensums
    {
      ...
      description:
        'Curso el cual no se habilitaba en la division de ciencias de la ingenieria, pero podia ganarse asignandose los cursos y niveles en CALUSAC, ganando los 12 niveles necesarios',
      credits: 2,
    ...
    }, //correcto en todos los pensums
    {
      ...
      name: 'Deportes 2',
      description:
        'El curso de Deporte II, es parte fundamental en la continuidad y consolidación para cultivar una buena condición física, base para una buena salud física y mental. Además, tiene como objetivo aprovechar los valores transmitidos por el deporte para el desarrollo del trabajo en equipo, la solidaridad, la tolerancia y el juego limpio. Sus ejes son la educación física, la recreación y deporte, buscando con ello que el aprendizaje sea significativo en cada uno de los educandos. Desarrolla habilidades en el conocimiento de primeros respondientes en casos de emergencia personal y colectiva, así como desastres naturales. Es de destacar que como parte de esta casa de estudios “Universidad de San Carlos, Centro Universitario de Occidente” estamos comprometidos con el cuidado del medio ambiente, por lo que se promoverán actividades que permitan fortalecer el cuidado del medio natural, concibiendo el deporte y el medio ambiente como parte unida, ya que el deportista necesita del medio natural para realizar dicha conciencia social y natural.',
      credits: 2,
    }, //correcto en todos los pensums
    {
      code: '2793',
    ...
    }, //Creditos Correctos
    {
      ...
      description:
        'La formación del profesional de las ciencias de la ingeniería requiere de una preparación integral por lo que se hace necesario proveer al estudiante de una serie de elementos teóricos y metodológicos que nos proporciona la Ciencia; éstos elementos son fundamentales y necesarios para que pueda aplicarlos al conocimiento de la realidad, contribuir al proceso de elaboración de la ciencia, ya que es una herramienta fundamental e ineludible para contribuir con el mejoramiento de las condiciones del hombre y de la sociedad.',
      credits: 3,
    }, //Creditos correctos
    {
      code: '085',
    ...
    }, //Creditos correctos
    {
      ...
      name: 'Geologia',
      description:
        'Geologia capacita al estudiante a conocer la estructura de la Tierra y los efectos de la Tectonica de placas y lo capacita para identificación de rocas',
      credits: 3,
    }, //Creditos correctos
    {
      code: '746',
    ...
    }, //Creditos correctos
    {
      ...
      description:
        'Curso introductorio a la ingenieria enfocada ene la industria del petroleo',
      credits: 3,
    }, //Creditos segun pensum
    {
      code: '2801',
      name: 'Idioma Tecnico 4',
      description:
        'Curso el cual no se habilitaba en la division de ciencias de la ingenieria, pero podia ganarse asignandose los cursos y niveles en CALUSAC, ganando los 12 niveles necesarios',
      credits: 2,
    }, //Creditos correctos segun pensum
    //Civil
    {
      ...
      description:
        'Curso introductorio a la gestion de proyectos en la carrera',
      credits: 6,
    }, //Creditos correctos segun pensum
    {
      code: '925',
    ...
    }, //Creditos correctos
    {
      ...
      description:
        'Desarrolle, reconozca, formule y aplique conceptos relaciones de recurrencia, grafos, árboles y redes que sirvan de base para los cursos profesionales de la Escuela de Ciencias y Sistemas relacionados con las estructuras dinámicas utilizadas en el manejo eficiente de memoria primaria y secundaria',
      credits: 5,
    }, //Creditos correctos
    {
      code: '2800',
    ...
    {
      code: '926',
      name: 'Geologia del Petroleo',
      description:
        'Un curso de Geología del Petróleo en la carrera de ingeniería civil se centra en el estudio de los procesos geológicos que llevan a la formación y acumulación de hidrocarburos. El curso comienza con una introducción a los fundamentos geológicos de los depósitos de hidrocarburos, seguido por la caracterización geológica de estos depósitos. Se exploran los métodos de prospección geofísica y geoquímica utilizados para identificar y evaluar yacimientos petroleros. Además, se estudian los sistemas petroleros, incluyendo la generación, migración y atrapamiento de hidrocarburos. El curso también aborda las técnicas de exploración y perforación, así como la evaluación de reservas y la gestión de yacimientos. A lo largo del curso, se utilizan casos prácticos y estudios de campo para proporcionar una comprensión aplicada de los conceptos teóricos. Este curso proporciona a los estudiantes las habilidades necesarias para trabajar en la exploración y producción de petróleo, contribuyendo al desarrollo eficiente y sostenible del sector energético',
      credits: 3,
    }, //creditos segun pensum
    //Civil
    {
    ...
    }, //Creditos correctos
    {
      ...
      description:
        'La metrología estudia los sistemas de pesos y medidas. La metrología es la disciplina científica dedicada al análisis de los sistemas de medidas y pesos. Su objeto de estudio son las mediciones de magnitudes, impulsando la trazabilidad para favorecer la normalización.',
      credits: 3,
    }, //TODO: REVISAR, NO TIENE CODIGO y Creditos segun pensum
    {
      code: '2806',
      name: 'Principios De Metrologia',
      description:
        'La metrología estudia los sistemas de pesos y medidas. La metrología es la disciplina científica dedicada al análisis de los sistemas de medidas y pesos. Su objeto de estudio son las mediciones de magnitudes, impulsando la trazabilidad para favorecer la normalización.',
      credits: 3,
    }, //ESTE ES PA SISTEMAS y creditos correctos segun pensum
    {
      code: '678',
    ...
    }, //Creditos correctos segun pensum
    {
      ...
      name: 'Geofisica',
      description:
        'La geofísica es una rama de la geología que se centra en el estudio de las propiedades físicas de la Tierra y los procesos que ocurren en su interior y superficie.',
      credits: 4,
    }, //Creditos correctos segun pensum
    {
      code: '1068',
    ...
    },
    {
      ...
      description:
        'Este curso estudia los principios básicos de un compilador y / o intérprete, partiendo de la estructura interna del proceso de compilación, y describiendo las fases de este proceso. Se tratan en detalle las primeras fases del proceso: análisis lexicográfico, análisis sintáctico y traducción dirigida por la sintaxis. Para poner en práctica los conceptos aprendidos se realizan varias tareas y proyectos prácticos.',
      credits: 4, //Creditos correctos
    },
    {
      code: '2804',
    ...
    },
    {
      ...
      description:
        'Estudia sobre varias técnicas de representación de los datos en la memoria de una computadora y los algoritmos que los manipulan. Se enfatiza en las características de una buena programación: modularidad, ocultamiento de información, reutilización de código y estilo de programación',
      credits: 5,
    }, //Creditos correctos
    {
      code: '2807',
      name: 'Practica Inicial TI',
      description:
        'Los talleres correspondientes a la carrera de Ingeniería en Ciencias y Sistemas, se enfocan básicamente en elconocimiento práctico que adquiere el estudiante acerca de los diferentes elementos de hardware y software necesarios para coadyuvar al desarrollo de su futura vida profesional, facilitando la comprensión y el aprendizaje de los cursos en la etapa intermedia y avanzada de su carrera',
      credits: 0,
    }, //creditos correctos, no contiene creditos.
    ...
    }, //creditos correctos
    {
      ...
      name: 'Economia',
      description:
        'El curso introducirá al estudiante en el estudio de la economía, se abordarán los principios, variables e interacciones basados en la teoría y práctica para comprender el funcionamiento del sistema económico del país a un nivel microeconómico y macroeconómico para que los futuros profesionales puedan comprender como la economía genera cambios dentro de la sociedad',
      credits: 4,
    }, //creditos correctos
    {
      code: '2810',
    ...
    },
    {
      ...
      description:
        'Desarrolle, estudie y aplique conceptos sobre la arquitectura de los microprocesadores de la línea tecnológica INTEL/CISC. Aprenda la utilidad del lenguaje ensamblador como herramienta eficaz para acceso de los procesadores antes mencionados, como base elemental de un computador comercial, ejemplo: DMA, Buses, Interfaces básicas, Interrupciones y fundamentos de los procesadores RISC',
      credits: 5, //Creditos correctos
    },
    {
      code: '2812',
    ...
    {
      code: 'C',
      name: 'Geofisica del Petroleo',
      description:
        'El curso de Geofísica del Petróleo está diseñado para proporcionar a los estudiantes una comprensión profunda de los principios y técnicas geofísicas aplicadas a la exploración y producción de hidrocarburos. Este curso es fundamental para aquellos interesados en la industria del petróleo y gas, ya que aborda los métodos avanzados utilizados para localizar y evaluar reservas de petróleo y gas. Durante el curso, los estudiantes explorarán temas como la sismología de reflexión y refracción, la gravimetría, la magnetometría y la geoelectricidad. Se enfocará en la interpretación de datos geofísicos y en la integración de estos datos con información geológica para identificar y caracterizar yacimientos de hidrocarburos. El curso incluirá el uso de software especializado y técnicas computacionales para el procesamiento y análisis de datos geofísicos. Los estudiantes aprenderán a diseñar y ejecutar programas de adquisición de datos geofísicos, así como a interpretar los resultados para la toma de decisiones en la exploración y desarrollo de campos petroleros.',
      credits: 4,
    }, //TODO: REVISAR, NO TIENE CODIGO, creditos correctos segun pensum
    ...
    //Area Comun
    {
      ...
      name: 'Contabilidad 3',
      description:
        'La formación del profesional de Ingeniería Industrial abarca áreas diversas, una de éstas es el área contable que con el curso Contabilidad 3 dota a los estudiantes con conocimientos como presupuestos, flujo de caja, análisis financieros, entre otros, que constituyen la base de la toma de decisiones',
      credits: 3,
    }, //creditos correctos
    {
      code: '945',
    ...
    }, //creditos correctos
    {
      ...
      name: 'Hidrologia',
      description:
        'La Hidrología tiene un papel muy importante en el planeamiento del uso de los recursos hidráulicos y ha llegado a convertirse en parte fundamental de los proyectos de ingeniería que tienen que ver con suministro de agua, drenaje, protección contra la acción de ríos entre otros.',
      credits: 6,
    }, //creditos correctos
    {
      code: '1061',
    ...
    }, //creditos correctos
    {
      ...
      description:
        'Comprende y aplica el concepto de Exclusión mutua entre procesos. Considera los criterios adecuados para implementar las diferentes soluciones que existen en la administración de Sistemas Operativos.',
      credits: 5, //Creditos correctos
    },
    {
      code: '2815',
      ...
      description:
        'Proporcionar al estudiante los conocimientos, conceptos y procesos tecnológicos comúnmente utilizados en la automatización de la industria y sus procesos para luego aplicarlos de forma técnica para resolver un problema de la vida real.',
      credits: 4, //Creditos correctos
    },
    {
      code: '2816',
    ...
    }, //TODO: REVISAR, COMPARTE CODIGO CON GEOFISICA DE 5TO SEMESTRE DE CIVIL
    {
      ...
      description:
        'El curso de Ingeniería Sanitaria I, es un curso de carácter profesional y sus conceptos básicos se aplican en el diseño, supervisión y construcción de sistemas de agua potable, tanto rurales como urbanos',
      credits: 5, //Creditos correctos
    },
    {
      code: '798',
      ...
      description:
        'El curso de Ingeniería Sanitaria II es un curso de carácter profesional orientado al conocimiento de la planificación, supervisión y construcción de sistemas de drenaje sanitario y drenaje pluvial, considerando las normas de INFOM para este tipo de proyectos. Así mismo, se consideran las recomendaciones de OPS y de OMS',
      credits: 5, //Creditos correctos
    },
    //Mecanica
    {
    ...
    }, //creditos correctos
    {
      ...
      description:
        'introduce conceptos básicos de SQL y profundiza en el uso de Power BI para el análisis de datos comerciales. A través de proyectos prácticos, los estudiantes aprenderán a manejar consultas SQL y crear visualizaciones de datos en Power BI, aplicando DAX para análisis avanzados y presentación de reportes.',
      credits: 3, //Creditos correctos
    },
    //Sistemas
    {
      ...
      description:
        'En este curso se presentan técnicas de software avanzadas, relativas a los sistemas operativos; se presentan tópicos que permitirán a los estudiantes diseñar, utilizar y analizar los diferentes sistemas operativos existentes. El curso desarrollará un marco de referencia basado en el concepto de la administración de recursos como lo son la memoria, dispositivos y la información. Dentro de este marco de referencia se analizará casos de estudios específicos, así como una evaluación comparativa entre diversos sistemas operativos actuales',
      credits: 4, //Creditos correctos
    },
    {
      code: '2820',
    ...
    },
    {
      ...
      description:
        'El curso comprende el estudio profundo de los sistemas de bases de datos, buscando que el estudiante comprenda los modelos y componentes de bases de datos, así como la estructura interna de las mismas, las nuevas tecnologías y los aspectos teóricos que las fundamenta. El curso se divide en dos partes fundamentales: a. El funcionamiento de un sistema administrador de bases de datos: Manejo de transacciones, concurrencia, procesamiento de consultas, respaldo y recuperación. b. Los modelos de bases de datos y las tendencias de los sistemas de bases de datos. La base teórica para el desarrollo de aplicaciones en los diferentes modelos de bases de datos',
    ...
    //Civil
    {
      ...
      description:
        'El curso proporciona al estudiante las habilidades y herramientas para alcanzar las competencias necesarias para Planificar, Organizar, Ejecutar, Supervisar y Monitorear proyectos de infraestructura',
      credits: 6, //Creditos correctos
    },
    {
      code: '1062',
    ...
    //Mecanica
    {
      ...
      description:
        'La necesidad de ser más competitivos en un mundo globalizado, lleva a las empresas comerciales, industriales y de servicios a ser selectivos en la contratación del personal, pero además de la selección, se hace necesario que el puesto de trabajo esté bien diseñado para que el trabajador sea mucho más eficiente y que contribuya a mejorar la productividad. Por tal razón el curso de Ingeniería de Métodos debe capacitar al Ingeniero Industrial en el análisis y diseño de los puestos de trabajo, en este curso se tratará sobre las técnicas de estudio de trabajo, como análisis de movimientos, toma de tiempos, diagramas de proceso y sistemas de pago de salarios.',
      credits: 6,
    }, //creditos correctos
    {
      code: '947',
    ...
    }, //creditos correctos segun pensum
    {
      ...
      description:
        'El curso de Bases de Datos Avanzadas está diseñado para proporcionar a los estudiantes una comprensión profunda y práctica de las técnicas avanzadas en el diseño, implementación y gestión de bases de datos. Este curso es fundamental para aquellos interesados en el manejo eficiente de grandes volúmenes de datos y en la optimización del rendimiento de los sistemas de bases de datos. Durante el curso, los estudiantes explorarán temas como la arquitectura de bases de datos distribuidas, el diseño y administración de bases de datos NoSQL, y las técnicas de replicación y fragmentación de datos. Se hará hincapié en la aplicación de estos conceptos en el desarrollo de sistemas de información robustos y escalables. El curso incluirá el uso de herramientas y tecnologías modernas utilizadas en la industria, como sistemas de gestión de bases de datos (DBMS) avanzados, lenguajes de consulta (SQL y NoSQL), y plataformas de big data. Los estudiantes aprenderán a diseñar esquemas de bases de datos eficientes, a implementar procedimientos almacenados y a optimizar consultas para mejorar el rendimiento.',
      credits: 5, //Creditos correctos segun pensum
    },
    {
      code: '2828',
    ...
    },
    {
      ...
      name: 'Practicas Finales',
      description:
        ' Son 400 horas de trabajo en un Proyecto de tipo: Aplicado, Docencia o Investigación. El objetivo es poner en contacto al estudiante con aplicaciones de la carrera que ha estudiado.',
      credits: 0,
    },
    ...
    },
    {
      ...
      description:
        'El curso de Diseño de Estructuras de Concreto 2 está diseñado para proporcionar a los estudiantes una comprensión avanzada de los principios y técnicas utilizados',
    ...
    }, //TODO: REVISAR, NO TIENE CODIGO
    {
      ...
      name: 'Vibraciones',
      description:
        'Estudio de la teoría de las vibraciones y su aplicación a problemas de Ingeniería. Técnicas analíticas, numéricas y experimentales aplicadas con uno o más grados de libertad.',
      credits: 5,
    }, //creditos correctos
    {
      code: '790',
      name: 'Diseño de Maquinas 3',
      description:
        'Diseño de máquinas 3 es un curso complementario a los dos diseños anteriores, en donde se finaliza el análisis de los componentes de una maquina en términos generales. Los engranajes y la lubricación son los componentes que más énfasis reciben.',
      credits: 6,
    }, //creditos correctos segun pensum
    {
      code: '696',
    ...
    },
    {
      ...
      description:
        'Este curso busca proporcionar a los estudiantes una comprensión integral de la multitud de herramientas analíticas que se pueden utilizar para modelar, analizar, comprender y, en última instancia, diseñar procesos de negocio. La amplia gama de enfoques cubiertos incluye herramientas gráficas de diagramas de flujo, modelos deterministas para el análisis del tiempo del ciclo y las decisiones de capacidad, y métodos analíticos de teoría de colas, así como la minería de datos. Dichas tecnologías permitirán al profesional de la ingeniería en ciencias y sistemas, identificar los retos y oportunidades que se presentan en la fabricación global y la economía del conocimiento a través de la representación lo más real posible y sencilla de un proceso de negocios en una industria específica. El profesional podrá por medio del uso de un modelo, analizar el comportamiento y el rendimiento de un proceso de negocio real o teórico.',
      credits: 5, //creditos correctos
    },
    {
      code: '2838',
